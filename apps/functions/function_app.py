...
if func is not None:
    ...
    def mailboxes_test_connection(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.test_mailbox_connection(req.route_params["id"], _payload_with_headers(req)))

    @app.route(route="orders/{orderRunId}/timeline", methods=["POST"])
    def orders_timeline(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.order_observability_timeline(req.route_params["orderRunId"], _payload_with_headers(req)))

    @app.route(route="console/session", methods=["POST"])
    def console_session(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_session(_payload_with_headers(req)))

    @app.route(route="console/dashboard", methods=["POST"])
    def console_dashboard(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_dashboard(_payload_with_headers(req)))
    ...
    def console_artifacts_download(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_output_artifact(_payload_with_headers(req)))
    ...
    def console_routing_rules_upsert(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_upsert_routing_rule(_payload_with_headers(req)))

    @app.route(route="console/customers", methods=["POST"])
    def console_customers_upsert(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_upsert_customer_config(_payload_with_headers(req)))

    @app.route(route="console/mailboxes", methods=["POST"])
    def console_mailboxes_upsert(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_upsert_mailbox(_payload_with_headers(req)))
    ...
    def console_processor_profiles_upsert(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_upsert_processor_profile(_payload_with_headers(req)))
    ...
    def console_output_profiles_upsert(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_upsert_output_profile(_payload_with_headers(req)))

    @app.route(route="console/users", methods=["POST"])
    def console_users_upsert(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_upsert_console_user(_payload_with_headers(req)))
    ...
    def console_customer_users_assign(req: func.HttpRequest) -> func.HttpResponse:
        return _response(
            order_api.console_assign_customer_user(req.route_params["customerId"], _payload_with_headers(req))
        )
    ...
    def console_exceptions_resolve(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.console_resolve_exception(req.route_params["id"], _payload_with_headers(req)))
    ...
    def console_orders_reprocess(req: func.HttpRequest) -> func.HttpResponse:
        return _response(
            order_api.console_reprocess_order(req.route_params["orderRunId"], _payload_with_headers(req))
        )
    ...
    def console_orders_timeline(req: func.HttpRequest) -> func.HttpResponse:
        return _response(
            order_api.console_order_timeline(req.route_params["orderRunId"], _payload_with_headers(req))
        )

    @app.route(route="customers/{customerId}/users", methods=["POST"])
    def customer_users_assign(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.assign_customer_user(req.route_params["customerId"], _payload_with_headers(req)))

    @app.route(route="exceptions/{id}/resolve", methods=["POST"])
    def exceptions_resolve(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.resolve_exception(req.route_params["id"], _payload_with_headers(req)))

    @app.route(route="orders/{orderRunId}/reprocess", methods=["POST"])
    def orders_reprocess(req: func.HttpRequest) -> func.HttpResponse:
        return _response(order_api.reprocess_order(req.route_params["orderRunId"], _payload_with_headers(req)))
else:
    app = None
